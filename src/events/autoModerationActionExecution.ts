...
export const autoModerationActionExecution = onEvent('autoModerationActionExecution', {
	...
	async execute(actionExecution) {
		...
		try {
			...
			const isKeywordTrigger = actionExecution.ruleTriggerType === AutoModerationRuleTriggerType.Keyword || actionExecution.ruleTriggerType === AutoModerationRuleTriggerType.KeywordPreset;
			...
			await channel.send({
				...
				files: ['https://media.discordapp.net/attachments/357672131691282437/968540850453884988/christian-server.jpg?ex=68fba175&is=68fa4ff5&hm=bff87ada39923c27edad25ff90ad3ea79f96f456ddb59931571e3ca9f5d0ddc0&=&format=webp&width=1434&height=944']
			});
